...
#define LCD_CLR_CS() GPIO_ResetBits(LCD_CS_GPIO_PORT, LCD_CS_PIN)
#define LCD_CLR_A0() GPIO_ResetBits(LCD_RS_GPIO_PORT, LCD_RS_PIN)
#define LCD_CLR_WR() GPIO_ResetBits(LCD_WR_GPIO_PORT, LCD_WR_PIN)
#define LCD_CLR_RD() GPIO_ResetBits(LCD_RD_GPIO_PORT, LCD_RD_PIN)
#define LCD_CLR_RESET() GPIO_ResetBits(LCD_RESET_GPIO_PORT, LCD_RST_PIN)

#define LCD_SET_CS() GPIO_SetBits(LCD_CS_GPIO_PORT, LCD_CS_PIN)
#define LCD_SET_A0() GPIO_SetBits(LCD_RS_GPIO_PORT, LCD_RS_PIN)
#define LCD_SET_WR() GPIO_SetBits(LCD_WR_GPIO_PORT, LCD_WR_PIN)
#define LCD_SET_RD() GPIO_SetBits(LCD_RD_GPIO_PORT, LCD_RD_PIN)
#define LCD_SET_RESET() GPIO_SetBits(LCD_RESET_GPIO_PORT, LCD_RST_PIN)
/*********************************************************************
*
*       Public routines
*/
